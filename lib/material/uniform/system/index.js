...
function applyProjectionTransformUniform(renderArgs) {
    renderArgs.gl.uniformMatrix4fv(this.location, TRANSPOSE_ENABLED, renderArgs.projectionTransform);
}
...
function applyViewTransformUniform(renderArgs) {
    renderArgs.gl.uniformMatrix4fv(this.location, TRANSPOSE_ENABLED, renderArgs.viewTransform);
}
...
function applyInvViewTransformUniform(renderArgs) {
    renderArgs.gl.uniformMatrix4fv(this.location, TRANSPOSE_ENABLED, renderArgs.invViewTransform);
}
...
function applyWorldTransformUniform(renderArgs, drawRequest) {
    renderArgs.gl.uniformMatrix4fv(this.location, TRANSPOSE_ENABLED, drawRequest.worldTransform);
}
...
function applyWorldViewTransformUniform(renderArgs, drawRequest) {
    ...
    renderArgs.gl.uniformMatrix4fv(this.location, TRANSPOSE_ENABLED, WORK_MATRIX);
}
